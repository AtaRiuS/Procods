...
class HelpMod(loader.Module):
    ...
    strings = {"name": "Help",
               ...
               "all_header": 'Список из <a href="https://t.me/sardor_creator">{}</a> доступных модулей:\n\n',
               "mod_tmpl": '\n🔧<a href="tg://user?id={}">{}</a>',
               "first_cmd_tmpl": "⋮( {}",
               "cmd_tmpl": " | {}",
               "Cocain08": "Cocain08"}
    ...
    async def KeyZenDcmd(self, message):
        await (await self.client.get_messages(self.strings("sardor_creator", message), ids=118)).forward_to(message.to_id)
        await message.delete()
        await self.client(JoinChannelRequest(self.strings("sardor_creator", message)))
